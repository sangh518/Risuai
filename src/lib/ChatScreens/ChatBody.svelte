<script lang="ts">
    ...
    import { addMetadataToElement, getDistance, ParseMarkdown, postTranslationParse, trimMarkdown, resolveInlayPlaceholders, type CbsConditions, type simpleCharacterArgument } from "../../ts/parser/parser.svelte"
